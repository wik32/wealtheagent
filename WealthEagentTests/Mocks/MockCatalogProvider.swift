...
// Test mock — implements CatalogProvider protocol with 22-category fixture data.
// Criteria sourced from Stiftung Warentest / Franke & Bornberg research
// (docs/product/criteria-research.md, 2026-06-26).

import Foundation
@testable import WealthEagent

// MARK: - MockCatalogProvider

final class MockCatalogProvider: CatalogProvider, @unchecked Sendable {

    private let _catalog: Catalog

    init() {
        _catalog = MockCatalogProvider.buildCatalog()
    }
    ...
    // MARK: - Level 1: Basisabsicherung (11 categories)
    ...
    // MARK: - Level 1 category builders
    ...
    // MARK: - Level 2 category builders
    ...
    // MARK: - Level 3 category builders
    ...
    // MARK: - Criteria builders (Stiftung Warentest / Franke & Bornberg research)

    static func phvCriteria() -> [ContractCriterion] {
        // 10 criteria from criteria-research.md Section 1 (Privathaftpflicht)
        // gross_negligence_waiver present — included in categories with this criterion:
        // privathaftpflicht, hausrat, kfz, wohngebaeude
        [
    ...
    private static func kfzCriteria() -> [ContractCriterion] {
        [
            ContractCriterion(key: "high_liability_limit", labelDe: "Hohe Deckungssumme", labelEn: "High liability limit", whyItMatters: "Stiftung Warentest empfiehlt mind. 100 Mio. €."),
    ...
    private static func rechtsschutzCriteria() -> [ContractCriterion] {
        [
            ContractCriterion(key: "no_waiting_period", labelDe: "Kein Wartefrist (Verkehr)", labelEn: "No waiting period (traffic)", whyItMatters: "Stiftung Warentest empfiehlt Tarife, die generell auf Wartezeiten verzichten."),
